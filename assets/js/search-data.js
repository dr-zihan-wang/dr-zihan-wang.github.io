...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "I talk about how coworking spaces may act as informal skill ecosystems for the creative workforce.",
        section: "Posts",
        handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%5A%69%68%61%6E.%57%61%6E%67@%73%75%73%73%65%78.%61%63.%75%6B", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=MVWU9KwAAAAJ", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/sophia-vt-wang", "_blank");
        },
      },{
      id: 'light-theme',
